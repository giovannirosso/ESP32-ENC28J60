...
bool ENC28J60Class::begin(int MISO_GPIO, int MOSI_GPIO, int SCLK_GPIO, int CS_GPIO, int INT_GPIO, int SPI_CLOCK_MHZ, int SPI_HOST, uint8_t *mac_address, bool use_mac_from_efuse)
{
    tcpipInit();
    ...
    {
        esp_efuse_mac_get_custom(mac_address);
    }
    ...
    */
    eth_mac->set_addr(eth_mac, mac_address);
